    ...
    <div class="row justify-content-center">  
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/new_return_result" method="post">
                        @csrf
                        <fieldset>
                            <legend style="color: seagreen">WARD INFORMATION</legend>
                            <input class="form-control" type="text" value="{{$result['registered']}}" name="registered" placeholder="REGISTERED VOTES"><br>
                                @if ($errors->has('registered'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('registered') }}</strong>
                                    </span>
                                @endif
                            <input class="form-control" type="text" value="{{$result['acredited']}}" name="acredited" placeholder="ACREDITED VOTES"><br>
