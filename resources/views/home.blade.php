...
<div class="container p-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white h1 text-center bg-dark">SENATORIAL</div>
                <div class="card-body">
                    <div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white h1 text-center bg-dark">REPRESENTATIVE</div>
                <div class="card-body">
                    <div class="row">
                        @foreach($representative as $representative)
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header text-white bg-secondary">{{$representative['name']}}</div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead>
